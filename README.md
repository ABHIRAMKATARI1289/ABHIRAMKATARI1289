...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&center=true&vCenter=true&width=435&lines=Full+Stack+Data+Scientist;Software+Developer)](https://git.io/typing-svg)
---

```bash
abhi@nitk ~ % whoami
Abhi — Final Year EEE Student @ NITK Surathkal

abhi@nitk ~ % cat education.txt
- B.Tech, Electrical & Electronics Engineering @ NITK Surathkal
- Final Year

abhi@nitk ~ % cat experience.txt
- Intern @ ISRO

abhi@nitk ~ % cat goals.txt
- Targeting Data Scientist / SDE roles
- Currently prepping DSA + core CS fundamentals for placements
```
